  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <button onClick={() => navigate('/workouts')} className="text-gray-400 hover:text-white text-sm mb-2 transition-colors">
            ← Back
          </button>
        ...
        <div className="flex gap-2">
          <button onClick={() => setEditing(true)} className="bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors">
            Edit
          </button>
          <button onClick={handleDelete} className="bg-red-900/30 hover:bg-red-900/60 text-red-400 px-4 py-2 rounded-lg text-sm font-medium transition-colors">
            Delete
          </button>
        </div>
      </div>
      ...
      {workout.notes && (
        <p className="text-gray-400 bg-gray-900 border border-gray-800 rounded-xl px-5 py-4">{workout.notes}</p>
      )}
